...
class SuperFluxManager():
    ...
    def update_resources(self):
        ...
        self.free_excess_cores-=self.cores_per_task*self.tasks_per_job
        self.free_cores-=self.cores_per_task*self.tasks_per_job

        if self.gpus_per_task is not None:
            self.free_gpus-=self.gpus_per_task*self.tasks_per_job
