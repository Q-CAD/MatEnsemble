...
class GPUAffineStrategy(TaskSubmissionStrategy):
    """
    Implements the TaskSubmissionStrategy interface. This is esentially the same
    as the CPUAffineStrategy but it just checks the number of available GPUs
    ...
    def submit_until_ooresources(
        ...
        while (
            ...
            needed_gpus = cur_tasks_per_job * self.manager.gpus_per_task
            ...
            self.manager.free_gpus -= needed_gpus
