...
> If you want to ask a question, we assume that you have read the available
  [Documentation](https://matensemble.readthedocs.io/en/latest/?badge=latest).
...
- Provide project and platform versions (HPC system, how you installed MatEnsemble, etc.), depending on what
  seems relevant.
...
- Determine if your bug is really a bug and not an error on your side e.g.
  ...
  read the [documentation](https://matensemble.readthedocs.io/en/latest/?badge=latest). If you are looking for support, you might want to
...
- Which HPC system you are trying to run on
- Which Container you are using if applicable
- Scripts used to setup the environment
...
- We will try to reproduce the issue with your provided steps.
  ...
  we will ask you for those steps and mark the issue as `needs-repro`.
...
- Make sure that you are using the latest version.
- Read the [documentation](https://matensemble.readthedocs.io/en/latest/?badge=latest) carefully and find out if the functionality is already
  covered, maybe by an individual configuration.
- Perform a [search](/issues) to see if the enhancement has already been suggested. If it
...
- **Describe the current behavior** and **explain which behavior you expected to see
  instead** and why. At this point you can also tell which alternatives do not
  work for you.
- You may want to **include screenshots and animated GIFs** which help you
  demonstrate the steps or point out the part which the suggestion is related
  to. You can use [this tool](https://www.cockos.com/licecap/) to record GIFs on macOS and Windows, and [this tool](https://github.com/colinkeenan/silentcast)
...
## Styleguides
The [Numpy Docstring Style](https://www.sphinx-doc.org/en/master/usage/extensions/example_numpy.html) is preferred but is not strict. As long as a conventions
is followed and changes are documented the exact style is not very important.


### Commit Messages
Commit messages should be descriptive and as concise as can be made while still
