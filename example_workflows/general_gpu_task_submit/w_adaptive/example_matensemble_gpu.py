...
task_command = os.path.abspath("gpu_hello") #'sample_amd' #'mpi_helloworld.py' #make sure to make it executable by `chmod u+x <file.py>`
...
master = SuperFluxManager(task_list, task_command, None, tasks_per_job=1, cores_per_task=1, gpus_per_task=1, write_restart_freq=5)
...
master.poolexecutor(task_arg_list=task_arg_list, buffer_time=1, task_dir_list=None,adaptive=True)
